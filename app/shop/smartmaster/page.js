...
export default async function SmartMasterShopPage({ searchParams }) {
  ...
  const filters = [
    ...
    { value: "shirt", label: "Shirts", count: products.filter(p => (p.name || "").toLowerCase().includes("shirt") || (p.name || "").toLowerCase().includes("tee")).length },
    { value: "trousers", label: "Trousers", count: products.filter(p => (p.name || "").toLowerCase().includes("trouser") || (p.name || "").toLowerCase().includes("pant")).length },
  ];
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-50 to-white py-12 px-4 md:px-8">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="text-center pt-12">
            <div className="inline-flex flex-col items-center gap-6 p-10 bg-gradient-to-br from-white to-gray-50 rounded-3xl border border-gray-300 max-w-3xl mx-auto shadow-xl">
              ...
              <div className="space-y-3">
                ...
                <p className="text-gray-600">Our team can help you find the perfect casual wear for your needs.</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/shop"
                  className="px-6 py-3 bg-gray-900 text-white rounded-xl hover:bg-black font-semibold transition-colors"
                >
                  Browse All Brands
                </Link>
                <Link
                  href="/contact"
                  className="px-6 py-3 bg-white border-2 border-gray-300 text-gray-800 rounded-xl hover:bg-gray-50 font-semibold transition-colors"
                >
                  Contact Support
                </Link>
              </div>
